  ...
  <header class="sticky top-0 z-50 glass-panel border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
      ...
      <NuxtLink to="/" class="flex items-center gap-2 group">
        <div class="w-10 h-10 rounded-xl bg-brand-500/20 border border-brand-500/50 flex items-center justify-center text-brand-500 dark:text-brand-400 group-hover:scale-105 group-hover:shadow-[0_0_15px_rgba(6,182,212,0.5)] transition-all">
          <svg class="w-6 h-6 stroke-current" fill="none" viewBox="0 0 24 24" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
          </svg>
        </div>
        <div>
          <span class="font-display font-bold text-xl tracking-tight text-slate-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-300 transition-colors">
            ElectroTech <span class="text-brand-500">Studio</span>
          </span>
          <span class="block text-[10px] uppercase font-mono text-slate-500 dark:text-slate-400 tracking-wider">Electronics & Hardware</span>
        </div>
      </NuxtLink>
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          ...
          class="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-amber-500 dark:text-amber-400 transition-all border border-slate-200 dark:border-slate-700/60 flex items-center justify-center cursor-pointer select-none"
        ...
        <!-- Cart Button -->
        <NuxtLink to="/cart" class="relative p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 hover:text-brand-600 dark:hover:text-brand-400 transition-all border border-slate-200 dark:border-slate-700/60">
